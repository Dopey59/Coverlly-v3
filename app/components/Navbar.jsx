        ...
        <div className="container mx-auto ">
            ...
            <div className="hidden md:flex space-x-6 items-center">
              ...
              <div className="relative group">
                ...
                <div className="absolute hidden group-hover:block w-48 bg-white border rounded shadow-lg">
                  <a href="#cat3" className="block px-4 py-2 duration transition hover:bg-[#ff847c] hover:text-white hover:duration-500">Les Fraudes</a>
                  <a href="#cat1" className="block py-2 px-4 duration transition hover:bg-[#ff847c] hover:text-white hover:duration-500">Passe Partout</a>
                  <a href="#cat1" className="block py-2 px-4 duration transition hover:bg-[#ff847c] hover:text-white hover:duration-500">Personnaliser</a>
                </div>
              </div>
              <a href="/produits" className=" hover:text-gray-900">Tous nos produits</a>
          ...
          <div id="mobile-menu" className="hidden md:hidden">
            ...
            <div>
              ...
              <div className="pl-4">
                <a href="#cat1" className="block py-2 px-4 duration transition hover:bg-[#ff847c] hover:text-white hover:duration-500">Les Fraudes</a>
                <a href="#cat1" className="block py-2 px-4 duration transition hover:bg-[#ff847c] hover:text-white hover:duration-500">Passe Partout</a>
                <a href="#cat1" className="block py-2 px-4 duration transition hover:bg-[#ff847c] hover:text-white hover:duration-500">Personnaliser</a>
              </div>
            </div>
              <a href="#panier" className="block py-2 px-4 duration transition hover:bg-[#ff847c] hover:text-white hover:duration-500">Panier</a>
              <a href="/produits" className=" py-2 px-4 hover:text-gray-900">Tous nos produits</a>
          </div>
        </div>
      </nav>
      </>
