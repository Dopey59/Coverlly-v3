      ...
      <nav
        ...
        >
          ...
          <div className="flex justify-between items-center gap-x-1">
            ...
            {/* <!-- Collapse Button --> */}
            <button type="button" className="hs-collapse-toggle md:hidden relative size-9 flex justify-center items-center font-medium text-[12px] rounded-lg border border-gray-200 text-gray-800 hover:bg-blue-100 focus:outline-none focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none" id="hs-header-base-collapse"  aria-expanded="false" aria-controls="hs-header-base" aria-label="Toggle navigation"  data-hs-collapse="#hs-header-base" >
              ...
              <div className="py-2 md:py-0  flex flex-col md:flex-row md:items-center gap-0.5 md:gap-1">
                <div className="grow">
                  <div className="flex flex-col md:flex-row md:justify-end md:items-center gap-0.5 md:gap-1">
                    ...
                    <Link className="p-2 flex gap-2 items-center text-sm bg-gray-100 text-gray-800 hover:bg-blue-100 rounded-lg focus:outline-none focus:bg-gray-100" href="/contact" aria-current="page">
                    ...
                    <div className="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] [--is-collapse:true] md:[--is-collapse:false] ">
                      <button id="hs-header-base-dropdown" type="button" className="hs-dropdown-toggle w-full p-2 flex items-center text-sm text-gray-800 hover:bg-blue-100 rounded-lg focus:outline-none focus:bg-gray-100" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                      ...
                      <div className="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 relative w-full md:w-52 hidden z-10 top-full ps-7 md:ps-0 md:bg-white md:rounded-lg md:shadow-md before:absolute before:-top-4 before:start-0 before:w-full before:h-5 md:after:hidden after:absolute after:top-1 after:start-[18px] after:w-0.5 after:h-[calc(100%-0.25rem)] after:bg-gray-100" role="menu" aria-orientation="vertical" aria-labelledby="hs-header-base-dropdown">
                        <div className="py-1 md:px-1 space-y-0.5">
                          <Link className="p-2 md:px-3 flex items-center text-sm text-gray-800 rounded-lg hover:bg-blue-100 focus:outline-none focus:bg-gray-100" href="/produits/categorie/casual">
                            Collection Casual
                          </Link>
                          <Link className="p-2 md:px-3 flex items-center text-sm text-gray-800 rounded-lg hover:bg-blue-100 focus:outline-none focus:bg-gray-100" href="/produits/categorie/workers">
                            Collection Workers
                          </Link>
                          <Link className="p-2 md:px-3 flex items-center text-sm text-gray-800 rounded-lg hover:bg-blue-100 focus:outline-none focus:bg-gray-100" href="/produits/categorie/originaux">
                            Originaux
                          </Link>
                    ...
                    <Link className="p-2 md:px-3 flex items-center text-sm text-gray-800 rounded-lg hover:bg-blue-100 focus:outline-none focus:bg-gray-100" href="/suivi-de-commande">
                      Suivre votre commande
                    </Link>

                    <Link className="p-2 flex items-center text-sm text-gray-800 hover:bg-blue-100 rounded-lg focus:outline-none focus:bg-gray-100" href="/a-propos">
                    ...
                    <Link className="p-2 gap-2 flex items-center text-sm text-gray-800 hover:bg-blue-100 rounded-lg focus:outline-none focus:bg-gray-100" href="/produits">
                    ...
                    {/* <Link className="p-2 flex items-center text-sm text-gray-800 hover:bg-blue-100 rounded-lg focus:outline-none focus:bg-gray-100" href="/panier">
                      <svg className="shrink-0 size-4 me-3 md:me-2 block md:hidden" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                      Panier
                    </Link> */}
                  </div>
